...
def dashboard_eventos(request):
        ...
        tipos_deporte = ["Ajedrez", "Artes Marciales", "Atletismo", "Baile", "Baloncesto", "Beisbol",
                        "Boxeo", "Ciclismo", "Esgrima", "Futbol", "Gimnasia", "Golf", "Hockey",
                        "Natación", "Patinaje", "Rugby", "Tenis", "Voleibol", "Yoga"]
        for deporte in tipos_deporte:
                mu = usuarioEvento.objects.filter(genero = 'Femenino').count()
        context = {
                'usuario': usu_rol,
